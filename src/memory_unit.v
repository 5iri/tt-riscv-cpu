...
module memory_unit (
    ...
    assign read_enable = (instr_id == INSTR_LB)  || (instr_id == INSTR_LH) ||
                         (instr_id == INSTR_LW)  || (instr_id == INSTR_LBU) ||
                         (instr_id == INSTR_LHU);
    assign wr_enable   = (instr_id == INSTR_SB) || (instr_id == INSTR_SH) || (instr_id == INSTR_SW);
